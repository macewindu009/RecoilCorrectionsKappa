...
void RecoilCorrectorRoot(TString baseString = "recoilMvaZ",
    ...
    std::string fileDir = "/storage/jbod/nzaeh/ArtusRun3003NafPF/merged/";
...
*/
    ...
    TString proj[2] = {"recoMetPar",
                        "recoMetPerp"};
    //Local reference
    TString projLabel[2] = {"recoilMvaZParal",
                        "recoilMvaZPerp"};
    ...
    // ----------------->> Insert Iterations over proj, ptCut and jetCut
